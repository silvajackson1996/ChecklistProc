                            ...
                            <div class="col-sm-12">
								<div class="row">
									...
									<div class="col-md-4">
										...
										<option value="2" {{ $event->error_type == 2 ? 'selected' : ''}}>Erro de Sistema </option>
										<option value="3" {{ $event->error_type == 3 ? 'selected' : ''}}>Erro operacional</option>
										<option value="4" {{ $event->error_type == 4 ? 'selected' : ''}}>Erro de Infra</option>
									</select>
									</div>
